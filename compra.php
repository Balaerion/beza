...
if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){
	...
	foreach($_SESSION["products"] as $product){
		...
		<td><?php echo $currency; echo sprintf("%01.2f", ($precio * $product_qty)); ?></td>
		<td>&nbsp;</td>
		</tr>				
		<?php		
	...
	<td><br><br><br><br><br><br><a href="inventario.php" class="btn btn-success btn-block">Place Order <i class="glyphicon glyphicon-menu-right"></i></a></td>
	</tr>
	</tfoot>	
	<?php	
} else {
